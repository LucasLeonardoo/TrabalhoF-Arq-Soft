                ...
                for (x = 0; x < pecas.length; x++) {
                    ...
                    if (pecas[x].posicao.altura == i && pecas[x].posicao.largura == j) {
                        ...
                        if (pecas[x].exercitoId == ExercitoBrancoId) {
                            var append = "<img src='" + pecas[x].imagem + "' class='peca' id='" + nome_casa.replace("casa", "peca_branca") + "'/>";
                            $("#" + nome_casa).append(append);
                        }
                        else if (pecas[x].exercitoId == ExercitoPretoId) {
                            var append = "<img src='" + pecas[x].imagem + "' class='peca' id='" + nome_casa.replace("casa", "peca_preta") + "'/>";
                            $("#" + nome_casa).append(append);
                        }
